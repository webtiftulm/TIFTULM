...
class Agenda extends CI_Controller {
	...
	public function index() {
		try {
			...
			show_error('Terjadi error di Manajemen Agenda. Silakan coba lagi nanti.', 500, 'Kesalahan Server');
		}
	}
	...
	public function proses()
	{
		try {
			...
			// PROSES SETTING DRAFT
						...
						\Sentry\captureException($e);
			show_error('Terjadi error saat memproses data Agenda. Silakan coba lagi nanti.', 500, 'Kesalahan Server');
		}
   	}
		...
		if($this->form_validation->run() === FALSE) {
			...
			try {
				...
				redirect(base_url().'admin/agenda');
							...
							\Sentry\captureException($e);
				show_error('Terjadi error saat menambah agenda. Silakan coba lagi nanti.', 500, 'Kesalahan Server');
			}
		}
	}
		...
		try {
			...
			if($this->form_validation->run() === FALSE) {
				...
				redirect(base_url().'admin/agenda');
						...
						\Sentry\captureException($e);
			show_error('Terjadi error saat mengedit agenda. Silakan coba lagi nanti.', 500, 'Kesalahan Server');
		}
	}
	...
	public function delete($id_agenda) {
		try {
			...
			redirect(base_url().'admin/agenda');
						...
						\Sentry\captureException($e);
			show_error('Terjadi error saat menghapus agenda. Silakan coba lagi nanti.', 500, 'Kesalahan Server');
		}
	}
