...
class Home extends CI_Controller {
	...
	public function index()
	{
		try {
			...
			show_error('Terjadi error saat menampilkan halaman utama. Silakan coba lagi nanti.', 500, 'Kesalahan Server');
		}
	}
	...
	public function oops()
	{
		try {
			...
			$this->load->view('layout/wrapper', $data);
						...
						\Sentry\captureException($e);
			show_error('Terjadi error saat menampilkan halaman not found. Silakan coba lagi nanti.', 500, 'Kesalahan Server');
		}
	}
}
