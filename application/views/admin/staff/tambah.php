      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name="tugas" class="form-control" placeholder="Tugas Tambahan" value="<?php echo set_value('isi') ?>">
          </div>
        ...
        <label>ID SINTA</label>
                <input type="text" name="sinta" id="keywords" class="form-control" placeholder="ID SINTA" value="<?php echo set_value('password_hint') ?>">
        </div>
