    ...
    <div class="row">
      <div class="col-md-5">
        ...
        <div class="form-group">
            ...
            <input type="text" name="tugas" class="form-control" placeholder="Jabatan" value="<?php echo $staff->isi ?>">
          </div>
      ...
      <div class="col-md-7">
        ...
        <label>NIDN</label>
                <input type="text" name="keywords" id="keywords" class="form-control" placeholder="No Induk Dosen Nasional" value="<?php echo $staff->keywords ?>">
        </div>
        
        <div class="form-group">
        <label>ID SINTA</label>
                <input type="text" name="sinta" id="keywords" class="form-control" placeholder="ID SINTA" value="<?php echo $staff->password_hint ?>">
        </div>
