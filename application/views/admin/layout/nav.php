      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fa fa-download"></i>
              <p>R P S <i class="right fa fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="<?php echo base_url('admin/rps') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>List RPS</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/rps/tambah') ?>" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah Data RPS</p></a>
              </li>
            </ul>
          </li>
