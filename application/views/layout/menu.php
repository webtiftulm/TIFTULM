        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    ?>
                    <li class="sub-active"><a href="<?php echo base_url('berita/kategori/'.$nav_berita2->slug_kategori) ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> <?php echo $nav_berita2->nama_kategori; ?></a></li>
                    <?php } 
                     } 
                    ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <?php } ?> 
                    <li class="sub-active"><a href="<?php echo base_url('rps') ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> R P S</a></li>
                </ul>
            </li>
            <!-- PROFIL -->
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <?php } ?> 
                    <li class="sub-active"><a href="<?php echo base_url('pengajar') ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Staff Pengajar</a></li>
                </ul>
            </li>
